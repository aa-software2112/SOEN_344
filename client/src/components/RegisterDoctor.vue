      ...
      <div class="container reg-container" id="doctor-reg">
        ...
        <form v-if="canRegisterDoctor" @submit="checkForm" class="reg-form" action="">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" v-model="physician_permit_nb" name="physician_permit_nb"
                   id="physician_permit_nb">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select v-model="clinic_id" name=clinic_id class="form-control" required>
              ...
              <option value v-for="clinic in clinics" :value="clinic.id">{{ clinic.name + ", " + clinic.location }}
              </option>
            </select>
          </div>
          <div class="form-group">
